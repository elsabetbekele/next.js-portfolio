  ...
  return (
    <div className='pb-20 pt-36'>
      ...
      <div className="h-screen w-full dark:bg-black-100 bg-white 
       dark:bg-grid-white/[0.3] opacity-10
